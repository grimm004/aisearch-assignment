...
added_note = "Basic greedy enhanced breaks ties by visiting a random nearest city."
...
def greedy():
    ...
    while len(state) < len(distance_matrix):
        ...
        # Take a random city with the minimum path cost
        state.append(min_path_cities[random.randint(0, len(min_path_cities) - 1)])
